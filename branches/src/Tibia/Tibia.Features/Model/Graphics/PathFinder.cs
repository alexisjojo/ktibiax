...
namespace Tibia.Features.Model.Graphics {
    public class PathFinder {
        ...
        #region Properties
        public Dictionary<uint, byte> ModifiedItems { get { return modifiedItems; } }
        public byte[,] Grid { get { return mGrid; } set { mGrid = value; } }
        public bool Stopped { get { return mStopped; } }
        public int HeuristicEstimate { get { return mHEstimate; } set { mHEstimate = value; } }
        #endregion
        ...
        public bool FindPath(Location start, Location end) {
            ...
            parentNode.X = start.X.ToInt32();
            parentNode.Y = start.Y.ToInt32();
            ...
            while (mOpen.Count > 0 && !mStop) {
                ...
                for (int i = 0; i < 8; i++) {
                    ...
                    if (newG == parentNode.G) { /*Unbrekeable*/ continue; }
                    ...
                    newNode.G = newG;
                    newNode.H = mHEstimate * (Math.Abs(newNode.X - end.X.ToInt32()) + Math.Abs(newNode.Y - end.Y.ToInt32()));
                    newNode.F = newNode.G + newNode.H;
                    mOpen.Push(newNode);
                }
                mClose.Add(parentNode);
            }
            if (found) { mStopped = true; return true; }
            mStopped = true; return false;
        }
        #endregion
