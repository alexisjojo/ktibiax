...
namespace Keyrox.Scripting.Parser {
    public class ScriptActionResult {
        ...
        public ScriptLine LineToJump { get; set; }

        /// <summary>
        /// Gets or sets the section to jump.
        /// </summary>
        /// <value>The section to jump.</value>
        public ScriptSection SectionToJump { get; set; }

        /// <summary>
        /// Gets or sets the section to execute.
        /// </summary>
        /// <value>The section to execute.</value>
        public ScriptSection SectionToExecute { get; set; }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether [must re execute].
        /// </summary>
        /// <value><c>true</c> if [must re execute]; otherwise, <c>false</c>.</value>
        public bool MustReExecute { get; set; }
    }
}
