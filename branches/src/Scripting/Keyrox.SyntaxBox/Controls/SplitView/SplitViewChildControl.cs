...
namespace Keyrox.Windows.Forms.CoreLib
{
    /// <summary>
...
//			Keyrox.Windows.NativeMethods.OpenThemeData (this.Handle,"EDIT");
//			Keyrox.Windows.NativeMethods.OpenThemeData (this.vScroll.Handle,"SCROLLBAR");
//			Keyrox.Windows.NativeMethods.OpenThemeData (this.hScroll.Handle,"SCROLLBAR");
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.TopThumb = new Keyrox.Windows.Forms.CoreLib.ThumbControl();
            this.LeftThumb = new Keyrox.Windows.Forms.CoreLib.ThumbControl();
