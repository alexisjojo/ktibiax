...
using Keyrox.SyntaxBox.Properties;
using ScrollEventArgs=Keyrox.Windows.Forms.IntelliMouse.ScrollEventArgs;
using ScrollEventHandler=Keyrox.Windows.Forms.IntelliMouse.ScrollEventHandler;
...
//			this.Visible =false;
        ...
        protected void InitializeComponent()
        {
            ...
            this.regionHandler1 = new Keyrox.Windows.Forms.CoreLib.RegionHandler(this.components);
            // 
            // tmrFeedback
            // 
