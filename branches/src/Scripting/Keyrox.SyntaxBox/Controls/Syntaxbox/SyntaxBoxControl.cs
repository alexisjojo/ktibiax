...
using Keyrox.Drawing.GDI;
using Keyrox.SourceCode;
using Keyrox.Windows.Forms.CoreLib;
using Keyrox.Windows.Forms.SyntaxBox;
using System.Collections.Generic;

#endregion

namespace Keyrox.Windows.Forms
{
    /// <summary>
    ...
    public class SyntaxBoxControl : SplitViewParentControl
    {
        ...
        /// <summary>
        /// Occurs when [editor click].
        /// </summary>
        public event EventHandler EditorClick = null;
        ...
        public DevExpress.Utils.ToolTipController SyntaxToolTipController;

        [Browsable(false)]
        public Keyrox.Windows.Forms.SyntaxBox.Painter.IPainter Painter {
            get { return ((EditViewControl)_ActiveView).Painter; }
        }
        ...
        public SyntaxBoxControl()
        {
            try
            {
                ...
                ((EditViewControl)_ActiveView).Click += new EventHandler(SyntaxBoxControl_Click);
            }
            catch
            {
        ...
        protected void SyntaxBoxControl_Click(object sender, EventArgs e) {
            if (EditorClick != null) { EditorClick(sender, e); }
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.SyntaxToolTipController = new DevExpress.Utils.ToolTipController(this.components);
            this.SuspendLayout();
            // 
            // splitView
            // 
            this.SyntaxToolTipController.SetSuperTip(this.splitView, null);
            // 
            // _GutterIcons
            // 
            ...
            this._GutterIcons.Images.SetKeyName(0, "");
