...
namespace Keyrox.Scripting {
    public class ScriptDocument : Component {
        ...
        public void Setup(ScriptBox scriptbox) {
            ...
            this.ToolTip = new ScriptToolTipProvider(scriptbox.Editor);
        }

        #region "[rgn] Properties "
        public ScriptToolTipProvider ToolTip { get; set; }
        ...
        public void ShowAutoList() {
            ...
            //editor.Document.Parser.SyntaxDefinition.SpanDefinitions[0].
